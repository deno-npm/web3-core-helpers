...
export class errors {
  ...
  static ConnectionCloseError(
    event: WebSocketEvent | boolean,
  ...
  static RevertInstructionError(
    reason: string,
    signature: string,
  ): RevertInstructionError;
  static TransactionRevertInstructionError(
    reason: string,
    signature: string,
    receipt: object,
  ...
  static TransactionRevertedWithoutReasonError(
    receipt: object,
  ): TransactionError;
